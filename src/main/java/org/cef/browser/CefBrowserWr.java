    ...
    private void doUpdate() {
        ...
        if (OS.isMacintosh()) {
            ...
            synchronized (content_rect_) {
                ...
                content_rect_ = new Rectangle((int) (bounds.getX() * scaleFactor_), (int) (bounds.getY() * scaleFactor_), (int) (bounds.getWidth() * scaleFactor_), (int) (bounds.getHeight() * scaleFactor_));
