...
public class CefApp extends CefAppHandlerAdapter {
    ...
    private CefApp(String[] args, CefSettings settings) throws UnsatisfiedLinkError {
        ...
        if (OS.isWindows()) {
            ...
            System.load(System.getProperty("java.io.tmpdir") + "jcefwin64\\" + "chrome_elf.dll");
            //SystemBootstrap.loadLibrary("chrome_elf");
            System.load(System.getProperty("java.io.tmpdir") + "jcefwin64\\" + "libcef.dll");
            //SystemBootstrap.loadLibrary("libcef");

            // Other platforms load this library in CefApp.startup().
            System.load(System.getProperty("java.io.tmpdir") + "jcefwin64\\" + "jcef.dll");
                ...
                public void run() {
                    ...
                    if (OS.isMacintosh()) {
                        ...
                        if (settings.locales_dir_path == null) {
                            Path path = Paths.get(library_path, "resources/locales");
